...
"""
Background:
You are tasked with developing an object-oriented system to a simulate a zoo. The system should manage different types of animals and their interactions within the park. The goal is to create a dynamic environment where animals can eat, sleep and interact with each other and park’s visitors.
Specifications:
1.	Basics Objects
